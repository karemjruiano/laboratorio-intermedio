...
error_v=[0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001]
...
plt.errorbar(V_x, D1, xerr=error_v, yerr=error_D1)
plt.errorbar(V_x, D2, xerr=error_v, yerr=error_D2)
